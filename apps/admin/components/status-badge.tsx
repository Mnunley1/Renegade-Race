...
type StatusType =
  ...
  | "approved" | "rejected"
  | "succeeded" | "failed" | "processing" | "refunded" | "partially_refunded"
  | "enabled" | "restricted" | "disabled"
  | "active" | "inactive" | "banned"
  | "published" | "hidden" | "moderated" | "unmoderated"
  | "sending" | "archived"
...
const statusConfig: Record<string, { variant: "default" | "secondary" | "destructive" | "outline"; className?: string }> = {
  ...
  partially_refunded: { variant: "outline", className: "border-orange-500 text-orange-700 dark:text-orange-400" },
  enabled: { variant: "default", className: "bg-emerald-600" },
  restricted: { variant: "outline", className: "border-orange-500 text-orange-700 dark:text-orange-400" },
  ...
  unmoderated: { variant: "outline", className: "border-yellow-500 text-yellow-700 dark:text-yellow-400" },
