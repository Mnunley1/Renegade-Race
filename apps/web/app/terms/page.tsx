...
export const metadata: Metadata = {
  title: "Terms of Use",
  description: "Terms of Use for RaceRentals, LLC",
}
  ...
  return (
    <div className="container mx-auto max-w-4xl px-4 py-12">
      <div className="mb-8 text-center">
        <h1 className="mb-4 font-bold text-4xl md:text-5xl">Terms of Use</h1>
        <p className="text-lg text-muted-foreground">Effective as of January 9, 2025</p>
      </div>
        ...
        <CardContent className="space-y-8 p-8">
          <section>
            <p className="text-muted-foreground leading-relaxed">
              Welcome to the RaceRentals, LLC Terms of Use agreement. For purposes of this
              agreement, "Site" refers to the Company's website, which can be accessed at
              www.renegaderace.com. "Service" refers to the Company's services accessed via the
              Site, in which users can engage with motorsports service providers. The terms "we,"
              "us," and "our" refer to the Company. "You" refers to you, as a user of our Site or
              our Service.
            </p>
            <p className="mt-4 text-muted-foreground leading-relaxed">
              The following Terms of Use apply when you view or use the Service via our website
              located at www.renegaderace.com or by accessing the Service through clicking on the
              application (the "App") on your mobile device.
            </p>
            <p className="mt-4 text-muted-foreground leading-relaxed">
              Please review the following terms carefully. By accessing or using the Service, you
              signify your agreement to these Terms of Use. If you do not agree to be bound by these
              Terms of Use in their entirety, you may not access or use the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              privacy. When you access or use the Service, you signify your agreement to the Privacy
          ...
          <section>
            <h2 className="mb-4 font-bold text-2xl">ABOUT THE SERVICE</h2>
            <p className="text-muted-foreground leading-relaxed">
              The Service allows you to engage with motorsports service providers to rent cars,
              solicit sponsorships, mechanics, transportation, media personnel, etc.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4 text-muted-foreground leading-relaxed">
              You need to be at least 13 years old and a resident of the United States to register
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              messages from the Company. You agree to notify us immediately of any unauthorized use
              of your password and/or account. The Company will not be responsible for any
              liabilities, losses, or damages arising out of the unauthorized use of your member
          ...
          <section>
            <h2 className="mb-4 font-bold text-2xl">USE RESTRICTIONS</h2>
            <p className="mb-4 text-muted-foreground leading-relaxed">
            ...
            <ul className="ml-6 list-disc space-y-2 text-muted-foreground">
              ...
              <li>
                use the Site or the Service for the solicitation of business in the course of trade
                or in connection with a commercial enterprise;
              </li>
              <li>
                distribute any part or parts of the Site or the Service without our explicit written
                permission (we grant the operators of public search engines permission to use
                spiders to copy materials from the site for the sole purpose of creating
                publicly-available searchable indices but retain the right to revoke this permission
              ...
              <li>
                ...
                the Service, or use any software, technology, or device to scrape, spider, or crawl
                the Service or harvest or manipulate data;
              </li>
              <li>
              ...
              <li>
                publish or link to malicious content of any sort, including that intended to damage
          ...
          <section>
            <h2 className="mb-4 font-bold text-2xl">POSTING AND CONDUCT RESTRICTIONS</h2>
            <p className="mb-4 text-muted-foreground leading-relaxed">
              When you create your own personalized account, you may be able to provide your driving
              background, licenses held, sim racing stats, and offer your own services ("User
              Content") to the Service. You are solely responsible for the User Content that you
              post, upload, link to or otherwise make available via the Service.
            </p>
            <p className="mb-4 text-muted-foreground leading-relaxed">
            ...
            <p className="mb-4 text-muted-foreground leading-relaxed">
              ...
              express conditions surrounding User Content. You agree that failure to adhere to any
              of these conditions constitutes a material breach of these Terms.
            </p>
            <p className="mb-4 text-muted-foreground leading-relaxed">
            ...
            <ul className="ml-6 list-disc space-y-2 text-muted-foreground">
              ...
              <li>
                You retain all ownership rights in your User Content but you are required to grant
                the following rights to the Site and to users of the Service as set forth more fully
                under the "License Grant" and "Intellectual Property" provisions below: When you
                upload or post User Content to the Site or the Service, you grant to the Site a
              ...
              <li>
                ...
                proprietary rights, including privacy, publicity, trade secret, or others, unless
                you are the owner of such rights or have the appropriate permission from their
              ...
              <li>
                ...
                and/or all of your submissions, and terminate your account with or without prior
                notice.
              </li>
            </ul>
            <p className="mt-4 text-muted-foreground leading-relaxed">
              ...
              Service is solely your responsibility. The Site is not responsible for any public
              display or misuse of your User Content.
            </p>
            <p className="mt-4 text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="mb-4 font-bold text-2xl">ONLINE CONTENT DISCLAIMER</h2>
            <p className="mb-4 text-muted-foreground leading-relaxed">
              Opinions, advice, statements, offers, or other information or content made available
              through the Service, but not directly by the Site, are those of their respective
            ...
            <p className="mb-4 text-muted-foreground leading-relaxed">
              ...
              take no responsibility and assume no liability for any User Content that you or any
              other user or third party posts or sends via the Service. Under no circumstances will
              we be responsible for any loss or damage resulting from anyone's reliance on
            ...
            <p className="mb-4 text-muted-foreground leading-relaxed">
              ...
              reserve the right, but have no obligation, to monitor the materials posted in the
              public areas of the Site or the Service or to limit or deny a user's access to the
              Service or take other appropriate action if a user violates these Terms of Use or
              engages in any activity that violates the rights of any person or entity or which we
              deem unlawful, offensive, abusive, harmful or malicious. E-mails and messages sent
              between you and other participants that are not readily accessible to the general
              public will be treated by us as private to the extent required by applicable law. The
              Company shall have the right to remove any material that in its sole opinion violates,
              or is alleged to violate, the law or this agreement or which might be offensive, or
              that might violate the rights, harm, or threaten the safety of users or others.
              Unauthorized use may result in criminal and/or civil prosecution under Federal, State
              and local law. If you become aware of a misuse of our Service or violation of these
          ...
          <section>
            <h2 className="mb-4 font-bold text-2xl">LINKS TO OTHER SITES AND/OR MATERIALS</h2>
            <p className="mb-4 text-muted-foreground leading-relaxed">
              ...
              These links are provided as a courtesy to Service subscribers. We have no control over
              Third Party Sites or Third Party Applications, Software or Content or the promotions,
              materials, information, goods or services available on these Third Party Sites or
              Third Party Applications, Software or Content. Such Third Party Sites and Third Party
              Applications, Software or Content are not investigated, monitored or checked for
              accuracy, appropriateness, or completeness, and we are not responsible for any Third
              Party Sites accessed through the Site or any Third Party Applications, Software or
              ...
              imply our approval or endorsement. If you decide to leave the Site and access the
              ...
              policies, including these Terms of Use, no longer govern. You should review the
              applicable terms and policies, including privacy and data gathering practices, of any
              Third Party Site to which you navigate from the Site or relating to any applications
          ...
          <section>
            <h2 className="mb-4 font-bold text-2xl">COPYRIGHT COMPLAINTS AND COPYRIGHT AGENT</h2>
            <div className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  We respect the intellectual property rights of others and requires that the users
                  do the same. Pursuant to 17 U.S.C. 512(i) of the United States Copyright Act, we
                  have adopted and implemented a policy that provides for the termination in
                  appropriate circumstances of users of the Service who are repeat infringers. We
                  may terminate access for participants or users who are found repeatedly to provide
              ...
              <div>
                ...
                <p className="mb-4 text-muted-foreground leading-relaxed">
                  If you are a copyright owner or an agent thereof and believe, in good faith, that
                  any materials provided on the Service infringe upon your copyrights, you may
                  submit a notification pursuant to the Digital Millennium Copyright Act (see 17
                  U.S.C 512) ("DMCA") by sending the following information in writing to our
                  designated copyright agent at:
                </p>
                <div className="ml-4 text-muted-foreground">
                  <p>5540 Centerview Dr Ste 204</p>
                  <p>PMB 914045</p>
                  <p>Raleigh, North Carolina 27606-8012 US</p>
                </div>
                <ol className="mt-4 ml-6 list-decimal space-y-2 text-muted-foreground">
                  ...
                  <li>
                    A description of the material that is claimed to be infringing or to be the
              ...
              <div>
                <h3 className="mb-3 font-semibold text-foreground text-xl">(c) Counter-Notices</h3>
                <p className="mb-4 text-muted-foreground leading-relaxed">
                  If you believe that your User Content that has been removed from the Site is not
                ...
                <ol className="ml-6 list-decimal space-y-2 text-muted-foreground">
                  ...
                  <li>
                    ...
                    consent to the jurisdiction of the federal court in North Carolina and a
                ...
                <p className="mt-4 text-muted-foreground leading-relaxed">
                  ...
                  reinstate the removed content in ten (10) business days. Unless the copyright
                  owner files an action seeking a court order against the content provider, member
                  or user, the removed content may (in our sole discretion) be reinstated on the
                  Site in ten (10) to fourteen (14) business days or more after receipt of the
                  counter-notice.
                </p>
              </div>
            </div>
          ...
          <section>
            <h2 className="mb-4 font-bold text-2xl">LICENSE GRANT</h2>
            <p className="text-muted-foreground leading-relaxed">
              By posting any User Content via the Service, you expressly grant, and you represent
              and warrant that you have a right to grant, to the Company a royalty-free,
              ...
              User Content and your name, voice, and/or likeness as contained in your User Content,
              if applicable, in whole or in part, and in any form, media or technology, whether now
          ...
          <section>
            <h2 className="mb-4 font-bold text-2xl">INTELLECTUAL PROPERTY</h2>
            <p className="text-muted-foreground leading-relaxed">
              ...
              copyrights, trademarks and other proprietary rights. Other product and company names
              that are mentioned on the Service may be trademarks of their respective owners. We
              reserve all rights that are not expressly granted to you under these Terms of Use.
            </p>
          </section>
          ...
          <section>
            <h2 className="mb-4 font-bold text-2xl">EMAIL MAY NOT BE USED TO PROVIDE NOTICE</h2>
            <p className="text-muted-foreground leading-relaxed">
              Communications made through the Service's email and messaging system will not
              constitute legal notice to the Site, the Service, or any of its officers, employees,
              agents or representatives in any situation where legal notice is required by contract
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              . Opting out may prevent you from receiving messages regarding the Site, the Service
              or special offers.
            </p>
          </section>
          ...
          <section>
            <h2 className="mb-4 font-bold text-2xl">WARRANTY DISCLAIMER</h2>
            <p className="text-muted-foreground leading-relaxed">
              THE SERVICE, IS PROVIDED "AS IS," WITHOUT WARRANTY OF ANY KIND. WITHOUT LIMITING THE
              FOREGOING, WE EXPRESSLY DISCLAIM ALL WARRANTIES, WHETHER EXPRESS, IMPLIED OR
              ...
              REPRESENTATION THAT ACCESS TO OR OPERATION OF THE SERVICE WILL BE UNINTERRUPTED OR
              ERROR FREE. YOU ASSUME FULL RESPONSIBILITY AND RISK OF LOSS RESULTING FROM YOUR
              DOWNLOADING AND/OR USE OF FILES, INFORMATION, CONTENT OR OTHER MATERIAL OBTAINED FROM
              THE SERVICE. SOME JURISDICTIONS LIMIT OR DO NOT PERMIT DISCLAIMERS OF WARRANTY, SO
          ...
          <section>
            <h2 className="mb-4 font-bold text-2xl">LIMITATION OF DAMAGES; RELEASE</h2>
            <p className="mb-4 text-muted-foreground leading-relaxed">
              ...
              CONSEQUENTIAL OR EXEMPLARY DAMAGES, HOWEVER ARISING, THAT RESULT FROM: (A) THE USE,
              DISCLOSURE, OR DISPLAY OF YOUR USER CONTENT; (B) YOUR USE OR INABILITY TO USE THE
              SERVICE; (C) THE SERVICE GENERALLY OR THE SOFTWARE OR SYSTEMS THAT MAKE THE SERVICE
              AVAILABLE; OR (D) ANY OTHER INTERACTIONS WITH USE OR WITH ANY OTHER USER OF THE
              SERVICE, WHETHER BASED ON WARRANTY, CONTRACT, TORT (INCLUDING NEGLIGENCE) OR ANY OTHER
              LEGAL THEORY, AND WHETHER OR NOT WE HAVE BEEN INFORMED OF THE POSSIBILITY OF SUCH
              DAMAGE, AND EVEN IF A REMEDY SET FORTH HEREIN IS FOUND TO HAVE FAILED OF ITS ESSENTIAL
              PURPOSE. SOME JURISDICTIONS LIMIT OR DO NOT PERMIT DISCLAIMERS OF LIABILITY, SO THIS
              PROVISION MAY NOT APPLY TO YOU.
            </p>
            <p className="mb-4 text-muted-foreground leading-relaxed">
              If you have a dispute with one or more users, a restaurant or a merchant of a product
              or service that you review using the Service, you release us (and our officers,
            ...
            <p className="text-muted-foreground leading-relaxed">
              If you are a California resident using the Service, you may specifically waive
          ...
          <section>
            <h2 className="mb-4 font-bold text-2xl">MODIFICATION OF TERMS OF USE</h2>
            <p className="mb-4 text-muted-foreground leading-relaxed">
              We can amend these Terms of Use at any time and will update these Terms of Use in the
              event of any such amendments. It is your sole responsibility to check the Site from
              time to time to view any such changes in this agreement. Your continued use of the
              Site or the Service signifies your agreement to our revisions to these Terms of Use.
              We will endeavor to notify you of material changes to the Terms by posting a notice on
              our homepage and/or sending an email to the email address you provided to us upon
              ...
              paragraph) or waiver of our rights hereunder shall not be valid or effective except in
              a written agreement bearing the physical signature of one of our officers. No
          ...
          <section>
            <h2 className="mb-4 font-bold text-2xl">GENERAL TERMS</h2>
            <p className="mb-4 text-muted-foreground leading-relaxed">
              If any part of this Terms of Use agreement is held or found to be invalid or
              unenforceable, that portion of the agreement will be construed as to be consistent
              with applicable law while the remaining portions of the agreement will remain in full
              force and effect. Any failure on our part to enforce any provision of this agreement
              will not be considered a waiver of our right to enforce such provision. Our rights
              under this agreement survive any transfer or termination of this agreement.
            </p>
            <p className="mb-4 text-muted-foreground leading-relaxed">
            ...
            <p className="mb-4 text-muted-foreground leading-relaxed">
              ...
              United States of America and the laws of the State of North Carolina, without regard
              to conflict of law provisions.
            </p>
            <p className="mb-4 text-muted-foreground leading-relaxed">
              We may assign or delegate these Terms of Service and/or our Privacy Policy, in whole
              or in part, to any person or entity at any time with or without your consent. You may
              not assign or delegate any rights or obligations under the Terms of Service or Privacy
              Policy without our prior written consent, and any unauthorized assignment or
              delegation by you is void.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF USE, UNDERSTAND THE TERMS OF USE,
              AND WILL BE BOUND BY THESE TERMS AND CONDITIONS. YOU FURTHER ACKNOWLEDGE THAT THESE
              TERMS OF USE TOGETHER WITH THE{" "}
              <Link className="text-primary underline" href="/privacy">
                PRIVACY POLICY
              </Link>{" "}
              REPRESENT THE COMPLETE AND EXCLUSIVE STATEMENT OF THE AGREEMENT BETWEEN US AND THAT IT
