...
const statusConfig = {
  pending: { label: "Pending", variant: "outline" as const, className: "border-yellow-500 text-yellow-700 dark:text-yellow-500" },
  confirmed: { label: "Confirmed", variant: "default" as const, className: "border-green-500 text-green-700 dark:text-green-500" },
  cancelled: { label: "Cancelled", variant: "destructive" as const, className: "" },
  completed: { label: "Completed", variant: "secondary" as const, className: "border-gray-500 text-gray-700 dark:text-gray-400" },
