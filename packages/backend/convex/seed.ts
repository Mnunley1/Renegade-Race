  ...
  handler: async (ctx) => {
    ...
    const tracks = [
      {
        ...
        description: 'The "World Center of Racing" features the 31-degree high-banked tri-oval that has made Daytona legendary.',
      ...
      },
      {
        ...
        location: 'Austin, TX',
        description: 'State-of-the-art 3.427-mile circuit with elevation changes and challenging corners.',
      ...
      },
      {
        ...
        location: 'Sebring, FL',
        description: 'Historic 3.7-mile circuit known for its challenging surface and endurance racing heritage.',
    ...
    const vehicles = [
      ...
      },
      {
        ...
        engineType: 'V10',
        mileage: 2800,
        amenities: ['Lamborghini Dinamica Veicolo Integrata', 'Launch Control', 'Track Mode', 'Racing Seats'],
        addOns: [
          {
            name: 'GoPro Package',
            price: 75,
      ...
      },
      {
        ...
        engineType: 'Twin-Turbo V8',
        mileage: 5200,
        amenities: ['ProActive Chassis Control', 'Track Telemetry', 'Carbon Fiber Body', 'Active Aerodynamics'],
        addOns: [],
        isActive: true,
        isApproved: true,
        createdAt: now,
